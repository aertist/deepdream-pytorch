...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", choices=SupportedModels, help="Neural network (model) to use for dreaming", default=SupportedModels.GOOGLENET)
    ...
    parser.add_argument("--layers_to_use", type=str, help="Layer whose activations we should maximize while dreaming", default=['inception4c'])
